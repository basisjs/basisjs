...
var ORIGINAL_DEFAULT_CALLBACK = require('basis.data.action').DEFAULT_CALLBACK;
...
var ORIGINAL_CALLBACK_HANDLER = require('basis.data.action').CALLBACK_HANDLER;
...
var NetAction = AbstractAction.subclass({
  className: 'basis.data.action.NetAction',
  init: function(){
 ...
 */
NetAction.create = function(config){
  return new NetAction({ config: config }).create();
};

module.exports = {
  create: NetAction.create,
  NetAction: NetAction,
