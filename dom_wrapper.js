  ...
  (function(){
    ...
    */
    ...
    function createChildByFactory(node, config){
      ...
      config = Object.extend({
        ...
        selection: node.selection || node.controlSelection
      }, config);
    ...
    */
    var DOMTemplateMixin = function(SuperClass){
      ...
      var super_insertBefore = superClassProto.insertBefore;
      var super_removeChild = superClassProto.removeChild;
      ...
      return {
        ...
        insertBefore: function(newChild, refChild){
          // inherit
          var newChild = super_insertBefore.call(this, newChild, refChild);
        ...
        removeChild: function(oldChild){
          // inherit
          super_removeChild.call(this, oldChild);
    ...
    */
    var ChildNodesDataset = Class(AbstractDataset, {
      ...
      event_sourceNodeChanged: createEvent('sourceNodeChanged'),

      autoDestroy: true,

      event_sourceNodeChanged: function(object, oldSourceNode){
