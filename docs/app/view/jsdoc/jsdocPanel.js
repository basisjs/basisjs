  ...
  var JsDocPanel = basis.ui.Node.subclass({
    ...
    active: true,
    template: resource('template/jsdocPanel.tmpl'),
    ...
    parse: function(object, delta){
      ...
      if (newData.file)
      {
        var filename = newData.file.replace(app.core.BASE_URL_RX, '');
            ...
            DOM.createElement('UL',
              Object.iterate(newData.tags.param, function(key, value){
                ...
                return DOM.createElement('LI.param' + (isOptional ? '.optional' : ''),
                  ...
                  DOM.createElement('SPAN.types', app.view.parseTypes(types)),
                  (isOptional ? ' (optional)' : ''),
  ...
  var JsDocLinksPanel = basis.ui.Node.subclass({
    template: resource('template/jsdocLinksPanel.tmpl'),

    childClass: {
      template: resource('template/jsdocLinksPanelItem.tmpl'),
