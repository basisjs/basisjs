  ...
  (function(){
    ...
    var AbstractProperty = Class(DataObject, {
      ...
      */
      init: function(initValue, handlers, proxy){
        DataObject.prototype.init.method.call(this, {
          handlers: handlers
        });
    ...
    */
    var Property = Class(AbstractProperty, {
      ...
      */
      init: function(initValue, handlers, proxy){
        AbstractProperty.prototype.init.method.call(this, initValue, handlers, proxy);
      ...
      */
      destroy: function(){
        ...
        AbstractProperty.prototype.destroy.method.call(this);
    ...
    var DataObjectSet = Class(Property, {
      ...
      */
      init: function(config){
        ...
        Property.prototype.init.method.call(this, 'value' in config ? config.value : 0, config.handlers, config.proxy);
      ...
      */
      destroy: function(){
        ...
        Property.prototype.destroy.method.call(this);
      }
    });
