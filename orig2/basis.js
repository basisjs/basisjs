  ...
  */
  ...
  var Class = (function(){ 
    ...
    */
    ...
    var HP = false;  // temporary solution
    ...
    return getNamespace(namespace, BaseClass.create).extend({
      ...
      createHP: function(superClass){
        HP = true;
        var newClass = BaseClass.create.apply(this, arguments);
        HP = false;
  ...
  var EventObject = (function(){
    ...
    * @class
    */
    var EventObject = Class.createHP(null, {
     /**
      * Name of class.
      * @type {string}
      * @readonly
      ...
      */
      init: function(config){
        ...
        if (config)
        {
          ...
          // debug for
          ;;;if (this.traceEvents_) this.handlers_.push({ handler: { any: function(){ console.log('Event trace:', this, arguments) } }, thisObject: this });
      ...
      dispatch: function(eventName/*, arg1 .. argN */){
        ...
        if (handlersCount || behaviour)
        {
          ...
          if (handlersCount)
          {
            ...
            var func;
            for (var i = 0, config; config = handlers[i]; i++)
            {
              // debug for
