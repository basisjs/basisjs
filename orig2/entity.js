  ...
  (function(){
    ...
    */
    ...
    var ENTITYSET_INIT_METHOD = function(superClass, name){
      return function(config){
        ...
        // inherit
        superClass.prototype.init.method.call(this, config);
      }
    }
    ...
    var ENTITYSET_SYNC_METHOD = function(superClass){
      return function(data, set){
        ...
        var res = superClass.prototype.sync.method.call(this, data, set);
    ...
    */
    var EntitySet = Class(Dataset, {
      ...
      destroy: function(){
        // inherit
        Dataset.prototype.destroy.method.call(this);
    ...
    */
    var EntityGrouping = Class(Grouping, {
      ...
      getGroup: function(object, autocreate){
        var group = Grouping.prototype.getGroup.method.call(this, object, autocreate);
        if (group)
    ...
    */
    var Entity = Class(DataObject, {
      ...
      init: function(data){
        ...
        // inherit
        EventObject.prototype.init.method.call(this);
        ...
        for (var key in fields)
        {
          ...
          {
            //this.asd = fieldCleaner.bind(this, key);
