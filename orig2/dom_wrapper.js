  ...
  (function(){
      ...
      behaviour: {
        update: function(node, delta){
          ...
          if (parentNode)
          {
            ...
            parentNode.dispatch('childUpdated', this, this.info, [this.info, delta].merge(), delta);
    ...
    var PartitionNode = Class(AbstractNode, {
      ...
      */
      init: function(config){
        ...
        // inherit
        AbstractNode.prototype.init.method.call(this, config);
      },
    ...
    var InteractiveNode = Class(AbstractNode, {
      ...
      */
      destroy: function(){
        ...
        // inherit
        AbstractNode.prototype.destroy.method.call(this);
      }
    });
      ...
      datasetChanged: function(dataset, delta){
        ...
        if (delta.deleted)
        {
          ...
          else
          {
            for (var i = 0, item; item = delta.deleted[i]; i++)
            {
              ...
              delete this.colMap_[item.eventObjectId];
        ...
        if (delta.inserted)
        {
          ...
          for (var i = 0, item; item = delta.inserted[i]; i++)
          {
            ...
            newChild.cascadeDestroy = false;  // prevent auto destroy
          ...
          if (groupGetter && (!this.groupControl || this.groupControl.groupGetter !== groupGetter))
          {
            ...
            if (config)
            {
              ...
              if (typeof config.active == 'boolean')
                this.groupControl.setActive(config.active);

              if (typeof config.subscribeTo == 'number')
                this.groupControl.setSubscription(config.subscribeTo);
    ...
    var HtmlNode = Class(Node, {
      ...
      */
      init: function(config){
        ...
        // inherit init
        Node.prototype.init.method.call(this, config);
        config = config || {};
      ...
      destroy: function(){
        ...
        Node.prototype.destroy.method.call(this);
    ...
    */
    var HtmlContainer = Class(HtmlNode, {
      ...
      // DOM methods
      insertBefore: function(newChild, refChild){
        if (newChild = HtmlNode.prototype.insertBefore.method.call(this, newChild, refChild)) // inherit
        { 
      ...
      removeChild: function(oldChild){
        if (HtmlNode.prototype.removeChild.method.call(this, oldChild)) // inherit
        {
      ...
      clear: function(alive){
        ...
        // inherit
        HtmlNode.prototype.clear.method.call(this, alive);
      },
      setChildNodes: function(childNodes, keepAlive){
        ...
        HtmlNode.prototype.setChildNodes.method.call(this, childNodes, keepAlive);
    ...
    var Control = Class(HtmlContainer, {
      ...
      */
      init: function(config){
        ...
        // inherit
        HtmlContainer.prototype.init.method.call(this, config);
      ...
      */
      ...
      destroy: function(){
        ...
        HtmlContainer.prototype.destroy.method.call(this);
    ...
    var Selection = Class(Dataset, {
      ...
      */
      behaviour: {
        datasetChanged: function(dataset, delta){
          // inherit
          //Dataset.prototype.behaviour.datasetChanged.method.call(this, dataset, delta);
      ...
      add: function(nodes){
        ...
        return Dataset.prototype.add.method.call(this, items);
      },
      ...
      set: function(nodes){
        ...
        return Dataset.prototype.set.method.call(this, items);
      }
    });
