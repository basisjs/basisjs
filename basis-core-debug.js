...
}.body() + "//@ sourceURL=" + __curLocation + "src/package/core.js").call(basis.namespace("package.core"), basis.namespace("package.core"), basis.namespace("package.core").exports, this, __curLocation + "src/package/core.js", __curLocation + "src/package/", basis, function(url){ return basis.resource(__curLocation + "src/package/" + url) });})();